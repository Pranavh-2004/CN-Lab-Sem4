...
#===================================
set val(stop)    85;# time of simulation end
...
proc finish {} {
    ...
    close $file2
    exec nam out.nam &
    exec /home/vadis1108/Downloads/xgraph/bin/xgraph cw6.out &
    exec /home/vadis1108/Downloads/xgraph/bin/xgraph cw2.out &
    exit 0
}
